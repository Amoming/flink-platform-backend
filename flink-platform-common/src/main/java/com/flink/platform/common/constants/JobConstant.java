...
public class JobConstant {
    ...
    public static final Pattern FLINK_APP_ID_PATTERN = Pattern.compile("yarn\\s+application\\s+-kill\\s+(\\S+)");

    public static final Pattern SPARK_APP_ID_PATTERN = Pattern.compile("Application\\s+report\\s+for\\s+(\\S+)");
    ...
    public static final String FLINK_YARN_APPLICATION_NAME = "yarn.application.name";

    public static final String SPARK_YARN_APPLICATION_NAME = "--name";
