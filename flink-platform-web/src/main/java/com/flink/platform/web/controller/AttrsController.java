...
import static com.flink.platform.common.constants.Constant.SPARK;
...
import static com.flink.platform.common.enums.DeployMode.SPARK_YARN_CLIENT;
import static com.flink.platform.common.enums.DeployMode.SPARK_YARN_CLUSTER;
...
public class AttrsController {
    ...
    public ResultInfo<List<DeployMode>> deployModes(String type) {
        ...
        if (FLINK.equals(type)) {
            ...
            result = Arrays.asList(SPARK_YARN_CLIENT, SPARK_YARN_CLUSTER);
        } else {
