...
import static com.flink.platform.common.constants.JobConstant.FLINK_YARN_APPLICATION_NAME;
...
// 父类没有被实例化，都是子类实例化,同时子类调用父类的构造方法赋值config
@Slf4j
public abstract class FlinkCommandBuilder implements CommandBuilder {
    ...
    public JobCommand buildCommand(Long flowRunId, @Nonnull JobRunInfo jobRunInfo) throws Exception {
        ...
        configs.put(FLINK_YARN_APPLICATION_NAME, createAppName(jobRunInfo));
